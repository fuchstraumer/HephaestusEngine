...
namespace terrain {
	...
	double GeneratorBase::SimplexFBM(int x, int y, double freq, int octaves, float lac, float gain) {
		double sum = 0;
		float amplitude = 1.0;
	...
	double GeneratorBase::SimplexBillow(int x, int y, double freq, int octaves, float lac, float gain) {
		double sum = 0;
		float amplitude = 1.0;
		glm::dvec2 f;
