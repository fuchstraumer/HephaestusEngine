CImplicitGradient ground_gradient; ground_gradient.setGradient(0.0, 0.0, 0.0, 1.0);
		...
		CImplicitFractal terrain_type_fractal(FBM, GRADIENT, QUINTIC, 3, 0.125, false);
		...
		// Final output
		//CImplicitBlend final_out; final_out.setControlSource(&ground_gradient); final_out.setHighSource(&ground_select); final_out.setLowSource(&cave_select);
