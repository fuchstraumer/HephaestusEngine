...
namespace noise
{
  ...
  namespace module 
  {
    ...
    const double DEFAULT_TURBULENCE_FREQUENCY = DEFAULT_SIMPLEX_FREQUENCY;
    ...
    const int DEFAULT_TURBULENCE_SEED = DEFAULT_SIMPLEX_SEED;
