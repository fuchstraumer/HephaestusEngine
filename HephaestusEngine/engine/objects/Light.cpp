...
namespace objects {
	...
	ChunkLightingManager::ChunkLightingManager(Chunk * parent) : Parent(std::shared_ptr<Chunk>(parent)) {}

	void ChunkLightingManager::Update(){
	}


	/*
	
		Simple lighting methods: things like gamma adjustment and adjusting
		light levels/up down with the range capped by the constexpr nums
		below.
